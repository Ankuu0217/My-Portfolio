...
const ProjectImage = ({ src, alt, className = 'h-48' }) => {
    return (
        <div className={`w-full ${className} flex items-center justify-center bg-gray-950 rounded-xl overflow-hidden p-2`}>
            ...
            <div className='grid gap-12 grip-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                {projects.map((projects, index) => (
                    <div
                        ...
                        <div>
                            <ProjectImage src={projects.image} alt={projects.title} />
                        </div>
                        <div className='p-6'>
                    ...
                    <div className='bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative'>
                        ...
                        <div className='flex flex-col'>
                            <div className='w-full flex justify-center bg-gray-900 p-4 rounded-xl'>
                                <ProjectImage src={selectedProject.image} alt={selectedProject.title} className="h-64 lg:h-80" />
                            </div>
